...
SELECT c.course_name,
AVG(a.minutes_attended) AS average_attendance
FROM attendance a
JOIN enrollments e
...
-- Which students need attention because of
...
-- Which instructor is responsible for the
-- highest number of active enrollments?
SELECT i.full_name,
...
-- Final combined management report
SELECT
