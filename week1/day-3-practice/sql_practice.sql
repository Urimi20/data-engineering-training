-- Query 1: Show all orders (all columns and all rows)
SELECT *
FROM orders;
...
-- Query 34: Show customer_name as customer, product as item, and total_amount
...
-- Query: Show only completed orders
SELECT *
FROM orders
WHERE status = 'completed';


-- Query: Show orders where price is greater than 100
SELECT *
FROM orders
WHERE price > 100;


-- Query: Show completed orders where price is greater than 50
SELECT *
FROM orders
WHERE status = 'completed' AND price > 50;

-- Query: Show all orders sorted from most expensive to cheapest
SELECT *
FROM orders
ORDER BY price DESC;

-- Query: Show customer_name, product, and total_amount
