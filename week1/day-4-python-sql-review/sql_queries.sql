...
-- **What I understood:**
-- Python checks each record manually using an if statement. SQL applies the condition directly to the dataset.
...
**What I understood:**
Python counts manually using a dictionary. SQL uses built-in aggregation functions like COUNT and GROUP BY.
